...
for (const car of cars) {
    document.write(`<div>${car.id} ${car.name}</div>`);
}

// - За допомогою циклу for і document.write() вивести 10 блоків div c довільним текстом і індексом всередині
for (let i= 1; i <= 10; i++){
    document.write(`<div>${i} Glory to Ukraine!</div>`);
}

// - За допомогою циклу while вивести в документ 20 блоків h1 c довільним текстом всередині.
let i = 1;
while (i <= 20) {
    document.write(`<h1>russia is a terrorist state</h1>`);
    i++;
}
...
let j = 1;
while (j <= 20) {
    document.write(`<h1>${j} Be stronger than your excuses</h1>`);
    j++;
}
...
for (const product of products) {
    document.write(`<div class="product-card">
        ...
        <img src="${product.image}" alt="text" class="product-image">
 </div>`);
}
