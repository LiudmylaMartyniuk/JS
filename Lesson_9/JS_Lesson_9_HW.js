...
block.innerText = 'Angels from the realms of glory Wing your flight over all the earth Ye, who sang creations story Now proclaim Messiah\'s birth Come and worship, come and worship Worship Christ the newborn King Shepherds in the fields abiding';
...
for (const coursesAndDurationArrayElement of coursesAndDurationArray) {
    ...
    courseInfo.innerText = 'title: ' + coursesAndDurationArrayElement.title + ', duration: ' + coursesAndDurationArrayElement.monthDuration;
    document.body.append(courseInfo);
}
...
for (const courseElement of coursesAndDurationArray) {
    ...
    courseInfoDiv.classList.add('heading');
    courseInfoDiv.classList.add('description');
    courseInfoDiv.style.backgroundColor = 'black';
    courseInfoDiv.style.color = 'white';
    courseInfoDiv.style.fontSize = '10px';
    titleInfo.innerText = courseElement.title;
    durationInfo.innerText = courseElement.monthDuration;
    courseInfoDiv.append(titleInfo);
    courseInfoDiv.append(durationInfo);
    document.body.append(courseInfoDiv);
}
...
for (const coursesElement of coursesArray) {
    ...
    let ul = document.createElement('ul');
    for (const oneModule of coursesElement.modules) {
        let module = document.createElement('li');
        module.innerText = oneModule;
        ul.append(module);
    }
    div.classList.add('main');
    monthDuration.classList.add('small1');
    hourDuration.classList.add('small2');
    durationBox.classList.add('flex');
    durationBox.append(monthDuration, hourDuration);
    div.append(title, durationBox, ul);
    document.body.appendChild(div);
}